...
#define defaults_h
  ...
  #define DEFAULT_DIR_INVERT_MASK 0  //((1<<Y_DIRECTION_BIT)|(1<<Z_DIRECTION_BIT))
  #define DEFAULT_PULSE_INVERT_MASK  (0)
  ...
  #define DEFAULT_JUNCTION_DEVIATION 0.05 // mm
  #define DEFAULT_DIR_INVERT_MASK ((1<<Y_DIRECTION_BIT)|(1<<Z_DIRECTION_BIT))
  #define DEFAULT_PULSE_INVERT_MASK  (0)
  ...
  #define DEFAULT_JUNCTION_DEVIATION 0.05 // mm
  #define DEFAULT_DIR_INVERT_MASK (1<<Y_DIRECTION_BIT)
  #define DEFAULT_PULSE_INVERT_MASK  (0)
  #define DEFAULT_REPORT_INCHES 0 // false
  #define DEFAULT_AUTO_START 1 // true
  #define DEFAULT_INVERT_ST_ENABLE 0 // false
